					...
					<div id="main_content-left-centre">
				        ...
				        <!-- 豆邮的每一项 --> 
				         ...
				         <div class="doumail-form-div" >
							...
							<%--对话--隐藏表单 --%>	
					        <form action="/DouBan/DoumailServlet?pre_method=doumail_content&method=doumail_show" id="onSubmit" name="doumail_form" method="post" >
					        	<!-- 发表对话的文本框 -->
					          <div class="item">
...
/***********************************************/
	...
	function toAjax(c){
		...
		xmlHttpRequest.open("post","http://localhost:8080/DouBan/DoumailServlet",true);
